...
TABLE;
    ...
    function add($data) {        
        ...
        . "VALUES ("
                ...
                . "'%s', '%s', '%s', '%d')", 
                #''.$data['id_contacto'].'', 
                ''.$data['parametros']['nombre'].'', 
                ''.$data['parametros']['apellido_paterno'].'', 
                ''.$data['parametros']['apellido_materno'].'',
                ''.$data['parametros']['edad'].''
                );
    ...
    function update($data) {
        ...
        .((array_key_exists('apellido_p', $data['parametros']) ? ",apellido_p = '".$data['parametros']['apellido_paterno']."' " : '')) 
        .((array_key_exists('apellido_m', $data['parametros']) ? ",apellido_m = '".$data['parametros']['apellido_materno']."' " : '')) 
